...
public class Assignment_SmoothCamera : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        Vector3 targetPosition = target.position + offset.normalized * currentZoomDistance + Vector3.up * offset.y; // 높이 유지
        ...
        Vector3 look = (targetPosition - transform.position).normalized;

        Quaternion targetRotation = Quaternion.LookRotation(look); // z축이 해당 방향을 보게 하는거
