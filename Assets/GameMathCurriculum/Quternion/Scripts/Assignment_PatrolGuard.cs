...
public class Assignment_PatrolGuard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // TODO
        // 계속 앞으로 가고 있으니 forward 와 전환할 방향으로 각도 구하기
        Quaternion angle = Quaternion.FromToRotation(transform.forward, dirToNext);

        // TODO
        // angle만큼 곱해서 현재 rotation에 더해주기
        Quaternion targetRotation = angle * transform.rotation;
        // 해당 방향으로 속도에 따라 돌게끔 설정
        // Slerp 는 점점 줄어들고 빨라지는 설정도 있고, RotateTowards 는 일정한 속도
